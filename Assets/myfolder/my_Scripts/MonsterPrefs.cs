...
public class MonsterPrefs : MonoBehaviour {
    ...
    {
		Vector3 firstPosition = new Vector3(0.3f, 0.5f, -2); // left
		Vector3 secondPosition = new Vector3(2.3f, -0.59f, -4); // down
		Vector3 thirdPosition = new Vector3(2.7f, 1.5f, -1); // up
		Vector3 fourthPosition = new Vector3(4.7f, 0.4f, -3); // right
