...
public class MonsterPrefs : MonoBehaviour {
    ...
    {
		Vector3 firstPosition = new Vector3(0.5f, 0.5f, -2); // left
		Vector3 secondPosition = new Vector3(1.8f, -0.39f, -4); // down
		Vector3 thirdPosition = new Vector3(2.2f, 1.1f, -1); // up
		Vector3 fourthPosition = new Vector3(3.5f, 0.4f, -3); // right
